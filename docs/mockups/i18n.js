...
window.MP_I18N = (function () {
  ...
  const strings = {
    ...
    "rank.yourSkill": { id: "Skill kamu", en: "Your skill" },
    "rank.reliability": { id: "Reliabilitas", en: "Reliability" },
    "rank.provisional": { id: "Provisional", en: "Provisional" },
    "rank.blockedBracket": { id: "Rating kamu melebihi maks bracket pemula (3.49). Daftar Intermediate atau baca cara kerja rating.", en: "Your rating exceeds this beginner bracket max (3.49). Register for Intermediate or read how ratings work." },
    "rank.eligibilityTitle": { id: "Eligibilitas rating", en: "Rating eligibility" },
