...
window.MP_GalleryChrome = (function () {
  ...
  function screenNavKey(screenId) {
    const map = {
      ...
      "event-americano": "events",
      "event-mexicano": "events",
      "format-round-robin": "events",
      "format-league": "events",
      "global-tournament": "events",
      "boc-fixture-detail": "events",
      "sparring-detail": "events",
      tournament: "events",
