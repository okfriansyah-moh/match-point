...
window.MP_I18N = (function () {
  ...
  const strings = {
    ...
    "title.events": { id: "Acara & Turnamen", en: "Events & Tournaments" },
    ...
    "flow.hint.events": {
      id: "Acara komunitas · Americano, Mexicano, Bracket",
      en: "Community events · Americano, Mexicano, Bracket",
    },
    "flow.hint.americano": {
    ...
    "flow.adminCreateEventDesc": {
      id: "Americano, Mexicano, atau Bracket — padel & tennis",
      en: "Americano, Mexicano, or Bracket — padel & tennis",
    },
    ...
    "flow.eventsIntro": {
      id: "Format sosial & kompetitif — poin individual, partner rotasi. Sama untuk padel & tennis.",
      en: "Social & competitive formats — individual points, rotating partners. Same for padel & tennis.",
    },
    ...
    "flow.cta.eventsTitle": {
      id: "Acara & Turnamen",
      en: "Events & Tournaments",
    },
    "flow.cta.eventsDesc": {
      id: "Americano, Mexicano, bracket — daftar & main",
      en: "Americano, Mexicano, bracket — register & play",
    },
